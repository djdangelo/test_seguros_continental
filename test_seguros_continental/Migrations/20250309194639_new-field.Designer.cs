...
namespace test_seguros_continental.Migrations
{
    ...
    [Migration("20250309194639_new-field")]
            ...
            modelBuilder.Entity("test_seguros_continental.Domain.Entities.Quote.QuoteEntity", b =>
                {
                    ...
                    b.HasOne("test_seguros_continental.Domain.Entities.TypeInsurance.TypeInsuranceEntity", "TypeInsuranceEntity")
                        .WithMany()
                    ...
                    b.Navigation("TypeInsuranceEntity");
                });
